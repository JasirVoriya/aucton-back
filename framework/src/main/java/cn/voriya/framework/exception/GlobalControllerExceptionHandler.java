...
public class GlobalControllerExceptionHandler {
    ...
    public ResultMessage<Object> handleServiceException(final Exception e) {
    ...
    public ResultMessage<Object> runtimeExceptionHandler(final Exception e) {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ResultMessage<Object> illegalArgumentHandler(final Exception e) {
        log.error("全局异常[RuntimeException]:", e);
    ...
    @ResponseBody
    public ResultMessage<Object> validExceptionHandler(final Exception e) {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public ResultMessage<Object> constraintViolationExceptionHandler(final Exception e) {
