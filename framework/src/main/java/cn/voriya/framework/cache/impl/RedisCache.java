package cn.voriya.framework.cache.impl;
...
@Slf4j
@Component
public class RedisCache implements Cache<Object> {
     ...
     */
    @Override
    public long incrData(String key, int data) {
        if (data < 0) {
     ...
     */
    @Override
    public long decrData(String key, int data) {
        if (data < 0) {
